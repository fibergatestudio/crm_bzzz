...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <a href="{{ route('sends::np') }}" class="btn btn-xl btn-outline-primary">Создать накладную</a> <a href="{{ route('sends::sms') }}" class="btn btn-xl btn-outline-primary">Отправить SMS</a>
</div>
@endsection