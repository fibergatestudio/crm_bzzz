...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-2">
            <ul class="nav">
                <a data-toggle="tab" href="#unprocessed"><button class="btn btn-danger btn-lg">36<br> необработанных</button></a>
            </ul>
        </div>
        <div class="col-2 text-center">
            <button style="margin-top: 15px;" class="btn btn-info">Добавить новый заказ по телефону</button>
        </div>
    </div>
    <br>
    <div class="tab-content">
        <div id="unprocessed" class="tab-pane fade">
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#home"><button class="btn btn-light">Все заказы(36)</button></a></li>
                <li><a data-toggle="tab" href="#menu1" class="active show"><button class="btn btn-light">Курьерская доставка(12)</button></a></li>
                <li><a data-toggle="tab" href="#menu2"><button class="btn btn-light">Самовызов из магазина(6)</button></a></li>
                <li><a data-toggle="tab" href="#menu3"><button class="btn btn-light">Наложенный платёж(18)</button></a></li>
            </ul>
                        ...
                        <tbody>
                            @foreach ($orders as $order)
                                <tr class="text-center">
                                    ...
                                    <th>комментарий менеджера<br><a href="{{ route('orders::edit', ['id' => $order->id]) }}">изменить</a></th>
    ...
    <div class="row">
        <div class="col-2">
            <ul class="nav">
                <a data-toggle="tab" href="#processed"><button class="btn btn-primary btn-lg">130<br> обработанных</button></a>
            </ul>
        </div>
    </div>
    <br>
    <div class="tab-content">
        <div id="processed" class="tab-pane fade">
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#rdy0"><button class="btn btn-light">Все заказы(130)</button></a></li>
                <li><a data-toggle="tab" href="#rdy1" class="active show"><button class="btn btn-light">На сборке(25)</button></a></li>
